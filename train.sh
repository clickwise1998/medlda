...
java -Xmx15000m -cp out/medlda.jar cn.clickwise.classify.reform.svm_struct_main -c 5000 example/train.txt example/model

#java -Xmx10000m -cp out/medlda.jar cn.clickwise.classify.reform.svm_struct_classify example/test.txt example/model example/prediction
